...
- Widget showed nothing after reboot when `cookieHeader` config was unset (`undefined.trim()` TypeError blocked all refreshes)
...
[0.3.2]: https://github.com/Vbxlab/Kol/compare/v0.3.1...v0.3.2
